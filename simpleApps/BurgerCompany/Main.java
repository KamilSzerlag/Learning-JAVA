...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hamburger hamburger = new Hamburger(22, "normal", "chicken");
        System.out.println("Your order is hamburger with " +hamburger.addOnion()+ "," + hamburger.addTomato() + ", Price is  "+hamburger.getPrice());
